...
- ระบบหมวด Role ที่กำหนดเอง (Staff Category) — ไม่ผูกกับ Discord role จริง จัดการทั้งหมดผ่าน MongoDB
  ...
  - `/staffpanel` [แอดมิน] — สร้าง embed แบบถาวรในห้อง พร้อมปุ่ม ◀ ▶ เลื่อนดูทีละหมวดตามลำดับที่ตั้งไว้ ปุ่มไม่มีวันหมดอายุ (ใช้ customId matching ไม่ใช่ collector แบบมี timeout)
