...
**เวอร์ชันปัจจุบัน:** `v1.7.0` — ดูรายละเอียดการอัปเดตทั้งหมดที่ [CHANGELOG.md](./CHANGELOG.md)
...
| 👑 หมวด Role กำหนดเอง | จัดสมาชิกเข้าหมวด (OWNER, ADMIN, ...) เองได้ ไม่ผูกกับ Discord role จริง พร้อม panel ปุ่มเลื่อนดู |
